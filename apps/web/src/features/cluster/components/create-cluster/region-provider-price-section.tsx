...
import { ProviderRow, RegionProviderMatrixTable } from './region-provider-matrix-table'
...
export const RegionProviderPriceSection = ({ control, setValue }: RPPProps) => {
  ...
  return (
    <div className={flexGap4}>
      <h2 className={cn('text-3xl', 'sm:text-5xl')}>Region, Provider &amp; Price</h2>

      <div className={cn('mb-2 flex gap-2 flex-row', 'hidden', 'sm:block')}>
        <Controller
          name='tempProvider'
          control={control}
          render={({ field }) => (
