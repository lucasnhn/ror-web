...
export const standardLayouts: Layouts = {
  lg: [
    ...
    { i: 'configuration', x: 12, y: 0, w: 6, h: 4, minW: 4, minH: 5 },
    { i: 'team', x: 0, y: 4, w: 6, h: 5, minW: 4, minH: 5 },
    { i: 'AD groups', x: 6, y: 4, w: 6, h: 5, minW: 4, minH: 5 },
    ...
    { i: 'controlPanel', x: 18, y: 0, w: 6, h: 9, minW: 6, minH: 9 },
  ],
  md: [
    { i: 'cpu', x: 0, y: 0, w: 6, h: 4, minW: 4, minH: 4 },
    { i: 'memory', x: 6, y: 0, w: 6, h: 4, minW: 4, minH: 4 },
    ...
    { i: 'controlPanel', x: 20, y: 0, w: 6, h: 9, minW: 6, minH: 9 },
  ],
  sm: [
    { i: 'cpu', x: 0, y: 0, w: 4, h: 4, minW: 4, minH: 4 },
    { i: 'memory', x: 4, y: 0, w: 4, h: 4, minW: 4, minH: 4 },
    { i: 'configuration', x: 8, y: 0, w: 4, h: 4, minW: 4, minH: 5 },
    { i: 'team', x: 0, y: 4, w: 4, h: 5, minW: 4, minH: 5 },
    { i: 'AD groups', x: 4, y: 4, w: 4, h: 5, minW: 4, minH: 5 },
    { i: 'service-id', x: 8, y: 4, w: 4, h: 5, minW: 4, minH: 5 },
    { i: 'info', x: 0, y: 8, w: 12, h: 8, minW: 9, minH: 8 },
    //{ i: 'networks', x: 0, y: 12, w: 12, h: 16, minW: 9, minH: 16 },
    { i: 'controlPanel', x: 0, y: 28, w: 6, h: 9, minW: 6, minH: 9 },
  ],
  xs: [
    { i: 'cpu', x: 0, y: 0, w: 2, h: 4, minW: 2, minH: 4 },
    { i: 'memory', x: 2, y: 0, w: 2, h: 4, minW: 2, minH: 4 },
    { i: 'configuration', x: 4, y: 0, w: 2, h: 4, minW: 2, minH: 5 },
    { i: 'team', x: 0, y: 4, w: 2, h: 5, minW: 4, minH: 5 },
    { i: 'AD groups', x: 2, y: 4, w: 2, h: 5, minW: 4, minH: 5 },
