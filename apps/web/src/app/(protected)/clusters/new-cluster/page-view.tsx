...
spec:
  ...
  const validOptions = optionMap.filter((opt) => {
    const [provider, region] = opt.split('-')

    const providerOk = !form.tempProvider || form.tempProvider === provider
    const regionOk = !form.tempRegion || form.tempRegion === region
