      ...
      <div className='@container'>
        <div className='grid grid-cols-1 @[405px]:grid-cols-2 @[1005px]:grid-cols-4 gap-6 @[1005px]:gap-0'>
          ...
          <div className='col-span-1'>
            ...
            <div className='flex flex-col @[515px]:flex-row @[515px]:items-center gap-2 @[515px]:gap-4 mt-3'>
              <p className='@[515px]:border-r @[515px]:border-r-(--r-border-subtle) @[515px]:pr-4'>
                <span className='text-3xl'>{metrics.nodeCount}</span>{' '}
                <span className='mb-1'>node{metrics.nodeCount > 1 ? 's' : ''}</span>
              </p>
              <p>
                {metrics.nodePoolCount} node pool{metrics.nodePoolCount > 1 ? 's' : ''}
              </p>
            </div>
          </div>
          <div className='col-span-1'>
            ...
            <div className='flex flex-col @[515px]:flex-row @[515px]:items-center gap-2 @[515px]:gap-4 mt-3'>
              ...
              <p>
                <span className='text-3xl'>{metrics.cpuPercentage}%</span> <span className='mb-1'>usage</span>
              </p>
            </div>
          </div>
          <div className='col-span-1'>
            ...
            <div className='flex flex-col @[515px]:flex-row @[515px]:items-center gap-2 @[515px]:gap-4 mt-3'>
              <p className='@[515px]:border-r @[515px]:border-r-(--r-border-subtle) @[515px]:pr-4'>
                <span className='text-3xl'>{convertBytes(metrics.memoryConsumed, { useBinaryUnits: true })}</span>{' '}
                <span className='mb-1'>of {convertBytes(metrics.memory, { useBinaryUnits: true })}</span>
              </p>
              <p>
                <span className='text-3xl'>{metrics.memoryPercentage}%</span> <span className='mb-1'>usage</span>
              </p>
            </div>
          </div>
        </div>
