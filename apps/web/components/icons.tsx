...
export const DataCenterIcon = ({ className }: { className?: string}) => (
  ...
  export const BriefcaseBusinessIcon = ({ className }: { className?: string}) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width="24"
      height="24" 
  ...
  export const BoxesIcon = ({ className }: { className?: string}) => (
    <svg  
      xmlns="http://www.w3.org/2000/svg" 
      width="24" 
      height="24" 
  ...
  export const PencilOffIcon = ({ className }: { className?: string}) => (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      width="24" 
      height="24" 
